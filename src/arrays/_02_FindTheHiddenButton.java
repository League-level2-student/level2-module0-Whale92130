...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		String s = JOptionPane.showInputDialog(null, "Give me a positive number");
		...
		for (int o = 0; o < num; o++) {
			buttons[o] = new JButton();
			buttons[o].addActionListener(this);
			panel.add(buttons[o]);
		}
		...
		JOptionPane.showMessageDialog(null,
				"A random button will say me then dissapear you will have to click on the button that said me ot win.");
